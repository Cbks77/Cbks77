...
const socialLinks = [
  ...
  { name: 'Facebook', icon: Facebook, url: 'https://facebook.com/cbks-world', handle: '@cbks-world' },
  { name: 'LinkedIn', icon: Linkedin, url: 'https://linkedin.com/in/cbks77', handle: '@Cbks77' },
  { name: 'Discord', icon: DiscordIcon, url: 'https://discord.gg/cbks77', handle: '@cbks77' },
